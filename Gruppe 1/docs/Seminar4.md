...
3. Ingen autokorrelasjon/Uavhengige restledd
4. Normalfordelte restledd
5. Homoskedastiske restledd
...
Er det noen som kan tenke seg forskningsdesign som kan sørge for at denne antagelsen holder (tenk tilbake til forelesningene til Knutsen)? For dem som vil lære mer om metoder for å håndtere utelatt variabelskjevhet, anbefaler jeg *Counterfactuals and Causal Inference* av Morgan og Winship (2015).
