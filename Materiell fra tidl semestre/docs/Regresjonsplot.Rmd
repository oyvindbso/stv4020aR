...
```
```{r, include=F}
ggsave("../bilder/regplot1.png")
dev.off()
```
```{r echo = FALSE}
knitr::include_graphics("../bilder/regplot1.png")
```
...
```
```{r, include=F}
ggsave("../bilder/regplot2.png")
dev.off()
```
```{r echo = FALSE}
knitr::include_graphics("../bilder/regplot2.png")
```
...
```
```{r, include=F}
ggsave("../bilder/regplot3.png")
dev.off()
```
```{r echo = FALSE}
knitr::include_graphics("../bilder/regplot3.png")
```
...
```
```{r, include=F}
ggsave("../bilder/regplot4.png")
dev.off()
```
```{r echo = FALSE}
knitr::include_graphics("../bilder/regplot4.png")
```
...
```
```{r, include=F}
ggsave("../bilder/regplot5.png")
dev.off()
```
```{r echo = FALSE}
knitr::include_graphics("../bilder/regplot5.png")
```
...
```
```{r, include=F}
ggsave("../bilder/regplot6.png")
dev.off()
```
```{r echo = FALSE}
knitr::include_graphics("../bilder/regplot6.png")
```
...
```
```{r, include=F}
ggsave("../bilder/regplot7.png")
dev.off()
```
```{r echo = FALSE}
knitr::include_graphics("../bilder/regplot7.png")
```
...
```
```{r, include=F}
ggsave("../bilder/regplot8.png")
dev.off()
```
```{r echo = FALSE}
knitr::include_graphics("../bilder/regplot8.png")
```
...
```
```{r, include=F}
ggsave("../bilder/regplot9.png")
dev.off()
```
```{r echo = FALSE}
knitr::include_graphics("../bilder/regplot9.png")
```
...
```
```{r, include=F}
ggsave("../bilder/regplot10.png")
dev.off()
```

```{r echo = FALSE}
knitr::include_graphics("../bilder/regplot10.png")
```
...
ggsave("../bilder/regplot11.png")
dev.off()
```

```{r echo = FALSE}
knitr::include_graphics("../bilder/regplot11.png")
```
