...
1. Importer datasettet beer.csv eller beer.Rdata fra [data-mappen på github]
(https://github.com/liserodland/stv4020aR/tree/master/H20-seminarer/Innf%C3%B8ringsseminarer/data) som et objekt i R-Studio.
...
3. Lag et spredningsplot (scatter-plot) med skatt på øl på x-aksen, og dødsrate i trafikken
per 10000 innbygger på y-aksen. Tegn deretter en lineær regresjonslinje oppå plottet.
...
datasettet. Gjør deretter en signifikanstest av sammenhengen mellom beertax og mrall.
Hva indikerer korrelasjonen mellom disse to variablene? 
...
skatt på øl reduserer dødsfall i trafikken? Tolk effekten substansielt. 
...
factor. Lag deretter et boxplot med state_fac på x-aksen og mrall på y-aksen. Vil du si det
er store variasjoner i dødsrate mellom statene (du kan trykke på Zoom over plottet for å se
tydelig)? Lag deretter det samme plottet som i oppgave 3, men legg til argumentet
...
8. Kjør en lineær regresjon med mrall som avhengig variabel og beertax, vmiles, unrate og
perinc og state_fac som uavhengige variabler. Lagre modellen som et objekt. Indikerer
modellen at skatt på øl reduserer dødsfall i trafikken? Tolk effekten substansielt. (P.S.:
